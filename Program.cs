...
namespace loops_Dallas
{
    class Program
    {
        //ask why do you want to make game and thenask for a whole number.
        ...
        //finds the number of spaces in the sentence.
        ...
        //finds the sum of the diget the user inputs.
